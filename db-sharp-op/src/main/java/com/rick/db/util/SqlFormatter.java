...
public class SqlFormatter {
	...
	public static String formatSql(String srcSql, Map<String,Object> param, Map<String, Object> formatMap) {
		...
		if(formatMap == null || param == null) {
			...
			for(ParamHolder h : paramList) {
				...
				if(h.oper.toUpperCase().endsWith("IN")) {
					...
					if ((invalues = strValue.split(PARAM_IN_SEPERATOR)).length > 0) {
